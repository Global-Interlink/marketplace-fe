            ...
            <table className="w-full whitespace-pre-wrap ">
              ...
              <tbody>
                ...
                <tr className="text-sm">
                  ...
                  <td className="px-6 py-2 text-gray-500">60</td>
                  <td className="px-6 py-2">
                    {
                     "Tier 1: 5 x 20 SUI\nTier 2: 5 x 10 SUI\nTier 3: 50 x 2 SUI"
                    }
                  </td>
                  <td className="px-6 py-2 text-gray-500">250 SUI</td>
                </tr>
                <tr className="text-sm">
                  <td className="px-6 py-2">{"> 2000 SUI"}</td>
                  <td className="px-6 py-2 text-gray-500">130</td>
                  <td className="px-6 py-2">
                    {
                      "Tier 1: 10 x 20 SUI\nTier 2: 20 x 10 SUI\nTier 3: 100 x 2 SUI"
                    }
                  </td>
                  <td className="px-6 py-2 text-gray-500">650 SUI</td>
                </tr>
                <tr className="text-sm">
                  <td className="px-6 py-2">{"> 5000 SUI"}</td>
                  <td className="px-6 py-2 text-gray-500">300</td>
                  <td className="px-6 py-2">
                    {
                      "Tier 1: 20 x 30 SUI\nTier 2: 30 x 15 SUI\nTier 3: 250 x 2 SUI"
                    }
                  </td>
                  <td className="px-6 py-2 text-gray-500">1,550 SUI</td>
                </tr>
                <tr className="text-sm">
                  <td className="px-6 py-2">{"> 10,000 SUI"}</td>
                  <td className="px-6 py-2 text-gray-500">500</td>
                  <td className="px-6 py-2">
                    {
                      "Tier 1: 40 x 30 SUI\nTier 2: 60 x 15 SUI\nTier 3: 400 x 3 SUI"
                    }
                  </td>
                  <td className="px-6 py-2 text-gray-500">3,600 SUI</td>
                </tr>
                <tr className="text-sm">
                  <td className="px-6 py-2">{"> 20,000 SUI"}</td>
                  <td className="px-6 py-2 text-gray-500">640</td>
                  <td className="px-6 py-2">
                    {
                      "Tier 1: 60 x 40 SUI\nTier 2: 80 x 20 SUI\nTier 3: 500 x 4 SUI"
                    }
                  </td>
                  <td className="px-6 py-2 text-gray-500">6,500 SUI</td>
                </tr>
                <tr className="text-sm">
                  <td className="px-6 py-2">{"> 50,000 SUI"}</td>
                  <td className="px-6 py-2 text-gray-500">1,700</td>
                  <td className="px-6 py-2">
                    {
                     "Tier 1: 120 x 40 SUI\nTier 2: 160 x 20 SUI\nTier 3: 1500 x 5 SUI"
                    }
                  </td>
                  <td className="px-6 py-2 text-gray-500">15,500 SUI</td>
                </tr>
              </tbody>
            </table>
          </div>
